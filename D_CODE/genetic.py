...
class SymbolicODE(BaseEstimator):
    ...
    def __init__(self,
                 population_size=1000, # total numer of programs at each generation
                 hall_of_fame=None,
                 n_components=None,
                 generations=20, # maximum number of generations
                 tournament_size=20, # number of programs to consider for crossover
                 stopping_criteria=0.0, # stopping criteria for early stopping
                 const_range=(-1., 1.),
                 init_depth=(2, 6), # min and max depth of initial programs
                 init_method='half and half',
                 function_set=None, # viene definito subito dopo
                 transformer=None,
                 metric='mean absolute error',
                 parsimony_coefficient=0.001, # try with parsimony_coefficient='auto'
                 p_crossover=0.9,
                 ...
                 low_memory=False,
                 n_jobs=1,
                 verbose=0, # set to 1 to get insights on the evolution process
                 random_state=None):
        ...
        self.building_blocks = None # member storing promising building blocks
